...
export function TagsClient({
  ...
  const viewSnippetsByTag = async (id: string) => {
    try {
  ...
  return (
    <div className="container py-6 max-w-4xl">
                      ...
                      <TableRow key={tag.id}>
                        <TableCell>
                          <Badge
                            ...
                            onClick={() => viewSnippetsByTag(tag.id)}
                          >
                            {tag.name}
                          </Badge>
                        </TableCell>
      ...
      <Dialog
        open={!!tagToEdit}
        onOpenChange={(open: boolean) => !open && setTagToEdit(null)}
      >
        <DialogContent>
          <DialogHeader>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete this tag and remove it from all of your snippets.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
